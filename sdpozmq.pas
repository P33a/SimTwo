...
type
  ...
  public
    ...
    function SetSockOpt(option: integer; value: integer): integer;
...
function TSdpoZMQ.SetSockOpt(option: integer; value: integer): integer;
begin
  result := zmq_setsockopt(Fsocket, option, @value, SizeOf(value));
end;
