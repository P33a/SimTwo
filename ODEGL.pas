...
uses
  OpenGL1x, OpenGLTokens, GLVectorGeometry, odeimport, GLScene, GLVectorTypes, GLVectorLists,
...
begin
  ...
  d := (Direction.v[0]*Pos.v[0]+Direction.v[1]*Pos.v[1]+Direction.v[2]*Pos.v[2]);
