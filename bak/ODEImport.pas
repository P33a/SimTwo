...
type
  ...
  // variables used between getInfo1() and getInfo2()
     limit : cint; // 0=free, 1=at lo limit, 2=at hi limit
  ...
  PdMass = ^TdMass;
   ...
   TdxAutoDisable = record
      ...
      idle_steps : cint; // steps the body needs to be idle to auto-disable it
   ...
   TdxQuickStepParameters = record
      num_iterations : cint; // number of SOR iterations to perform
...
// * a particular triangle.
  TdTriCallback = function(TriMesh,RefObject : PdxGeom; TriangleIndex : cint) : cint;

// * Per object callback. Allows the user to get the list of triangles in 1
// * shot. Maybe we should remove this one.
  TdTriArrayCallback = procedure(TriMesh,RefObject : PdxGeom; TriIndices:PIntegerArray; TriCount : cint);
...
// * to determine if a collision should occur.
  TdTriRayCallback = function(TriMesh,Ray : PdxGeom; TriangleIndex : cint; u,v:TdReal) : cint;
  ...
  TdObject = record
    ...
    tag       : cint;		// used by dynamics algorithms
  end;
  ...
  TdxJointAMotor = record
     ...
     num:cint;			// number of axes (0..3)
     mode:cint;			// a dAMotorXXX constant
  ...
  TdxBody = record
    ...
    flags : cint;			  // some dxBodyFlagXXX flags
    ...
    adis_stepsleft : cint;  // steps left to be idle
    ...
    average_counter : cuint; // counter/index to fill the average-buffers
    average_ready : cint; // indicates ( with = 1 ), if the Body's buffers are ready for average-calculations
  ...
  private
    function GetItems(i: cint): PdxBody;
    procedure SetItems(i: cint; const Value: PdxBody);
  public
    property Items[i : cint] : PdxBody read GetItems write SetItems; default;
...
(*struct dxWorld : public dBase {
  ...
  TdxWorld = record //(TdBase)
    ...
    nb,nj : cint;			  // number of bodies and joints in lists
  ...
  TdColliderFn = function(o1, o2 : PdxGeom; flags : cint;
                  contact : PdContactGeom; skip : cint) : cint; cdecl;
  TdGetColliderFnFn = function(num : cint) : TdColliderFn; cdecl;
  TdGetAABBFn = procedure(g : PdxGeom; var aabb : TdAABB); cdecl;
  TdGeomDtorFn = procedure(o : PdxGeom); cdecl;
  TdAABBTestFn = function(o1, o2 : PdxGeom; var aabb2 : TdAABB) : cint; cdecl;
...
(*typedef struct dGeomClass {
  ...
  // Tri-list collider
  TdintegerArray = array[0..65535] of cint;
...
(*struct dxTriMeshData{
  ...
  TdxHeightfieldData = record
    ...
    m_fScale : TdReal;
    m_fOffset : TdReal;
    m_nWidthSamples : cint;
    m_nDepthSamples : cint;
    m_bCopyHeightData : cint;
    m_bWrapMode : cint;
    m_nGetHeightMode : cint;
...
struct dxHashSpace : public dxSpace {
  ...
  {$ifdef cSINGLE}
     Padding : byte;
  {$endif}
     _type : cint;	// class of this object
     ...
     aabb : TdAABB;
     category_bits,collide_bits : culong;
  end;

  TGeomList = class(TList)
  private
    function GetItems(i: cint): PdxGeom;
    procedure SetItems(i: cint; const Value: PdxGeom);
  public
    property Items[i : cint] : PdxGeom read GetItems write SetItems; default;
  ...
  TdxHashSpace = record
    BaseSpace : TdxSpace;
    global_minlevel : cint;
    global_maxlevel : cint;
  end;
...
{$ENDIF}
  ...
  // added by PAR
   {$IFDEF PARODE}
   function dSphereGetClass: cint; cdecl; external {$IFDEF __GPC__}name 'dSphereGetClass'{$ELSE} ODEDLL{$ENDIF __GPC__};
   function dBoxGetClass: cint; cdecl; external {$IFDEF __GPC__}name 'dBoxGetClass'{$ELSE} ODEDLL{$ENDIF __GPC__};
   function dCylinderGetClass: cint; cdecl; external {$IFDEF __GPC__}name 'dCylinderGetClass'{$ELSE} ODEDLL{$ENDIF __GPC__};
   function dCapsuleGetClass: cint; cdecl; external {$IFDEF __GPC__}name 'dCapsuleGetClass'{$ELSE} ODEDLL{$ENDIF __GPC__};
   function dRayGetClass: cint; cdecl; external {$IFDEF __GPC__}name 'dRayGetClass'{$ELSE} ODEDLL{$ENDIF __GPC__};
   function dPlaneGetClass: cint; cdecl; external {$IFDEF __GPC__}name 'dPlaneGetClass'{$ELSE} ODEDLL{$ENDIF __GPC__};
   function dConvexGetClass: cint; cdecl; external {$IFDEF __GPC__}name 'dConvexGetClass'{$ELSE} ODEDLL{$ENDIF __GPC__};
   function dTriMeshGetClass: cint; cdecl; external {$IFDEF __GPC__}name 'dTriMeshGetClass'{$ELSE} ODEDLL{$ENDIF __GPC__};
   function dHeightfieldGetClass: cint; cdecl; external {$IFDEF __GPC__}name 'dHeightfieldGetClass'{$ELSE} ODEDLL{$ENDIF __GPC__};
   function dGeomTransformGetClass: cint; cdecl; external {$IFDEF __GPC__}name 'dGeomTransformGetClass'{$ELSE} ODEDLL{$ENDIF __GPC__};
   {$ENDIF}

   procedure dInitODE; cdecl; external {$IFDEF __GPC__}name 'dInitODE'{$ELSE} ODEDLL{$ENDIF __GPC__};
   function dInitODE2(uiInitFlags : cuint) : cint; cdecl; external {$IFDEF __GPC__}name 'dInitODE2'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dWorldSetQuickStepNumIterations(const World: PdxWorld; const num: cint); cdecl; external {$IFDEF __GPC__}name 'dWorldSetQuickStepNumIterations'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dWorldGetQuickStepNumIterations(const World: PdxWorld): cint; cdecl; external {$IFDEF __GPC__}name 'dWorldGetQuickStepNumIterations'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  // Stepfast
  procedure dWorldStepFast1(const World: PdxWorld; const stepsize: TdReal; const iterations: cint); cdecl; external {$IFDEF __GPC__}name 'dWorldStepFast1'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dWorldSetAutoEnableDepthSF1(const World: PdxWorld; autodepth: cint); cdecl; external {$IFDEF __GPC__}name 'dWorldSetAutoEnableDepthSF1'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dWorldGetAutoEnableDepthSF1(const World: PdxWorld): cint; cdecl; external {$IFDEF __GPC__}name 'dWorldGetAutoEnableDepthSF1'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dWorldGetAutoDisableSteps(const World: PdxWorld): cint; cdecl; external {$IFDEF __GPC__}name 'dWorldGetAutoDisableSteps'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dWorldSetAutoDisableSteps(const World: PdxWorld; steps: cint); cdecl; external {$IFDEF __GPC__}name 'dWorldSetAutoDisableSteps'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dWorldGetAutoDisableFlag(const World: PdxWorld): cint; cdecl; external {$IFDEF __GPC__}name 'dWorldGetAutoDisableFlag'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dWorldSetAutoDisableFlag(const World: PdxWorld; do_auto_disable: cint); cdecl; external {$IFDEF __GPC__}name 'dWorldSetAutoDisableFlag'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dBodyGetFiniteRotationMode(const Body: PdxBody): cint; cdecl; external {$IFDEF __GPC__}name 'dBodyGetFiniteRotationMode'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dBodyGetGravityMode(const Body: PdxBody): cint; cdecl; external {$IFDEF __GPC__}name 'dBodyGetGravityMode'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dBodyGetJoint(const Body: PdxBody; const index: cint): TdJointID; cdecl; external {$IFDEF __GPC__}name 'dBodyGetJoint'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dBodyGetNumJoints(const Body: PdxBody): cint; cdecl; external {$IFDEF __GPC__}name 'dBodyGetNumJoints'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dBodyIsEnabled(const Body: PdxBody): cint; cdecl; external {$IFDEF __GPC__}name 'dBodyIsEnabled'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dBodySetFiniteRotationMode(const Body: PdxBody; const mode: cint); cdecl; external {$IFDEF __GPC__}name 'dBodySetFiniteRotationMode'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dBodySetGravityMode(const Body: PdxBody; const mode: cint); cdecl; external {$IFDEF __GPC__}name 'dBodySetGravityMode'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dBodySetQuaternion(const Body: PdxBody; var q: TdQuaternion); cdecl; external {$IFDEF __GPC__}name 'dBodySetQuaternion'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dBodySetRotation(const Body: PdxBody; var R: TdMatrix3); cdecl; external {$IFDEF __GPC__}name 'dBodySetRotation'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dBodyCopyPosition(const Body: PdxBody; var pos: TdVector3); cdecl; external {$IFDEF __GPC__}name 'dBodyCopyPosition'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dBodyCopyRotation(const Body: PdxBody; var R: TdMatrix3); cdecl; external {$IFDEF __GPC__}name 'dBodyCopyRotation'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dBodyCopyQuaternion(const Body: PdxBody; var quat: TdQuaternion); cdecl; external {$IFDEF __GPC__}name 'dBodyCopyQuaternion'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dBodyGetAutoDisableSteps(const Body: PdxBody): cint; cdecl; external {$IFDEF __GPC__}name 'dBodyGetAutoDisableSteps'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dBodySetAutoDisableSteps(const Body: PdxBody; steps: cint); cdecl; external {$IFDEF __GPC__}name 'dBodySetAutoDisableSteps'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dBodyGetAutoDisableFlag(const Body: PdxBody): cint; cdecl; external {$IFDEF __GPC__}name 'dBodyGetAutoDisableFlag'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dBodySetAutoDisableFlag(const Body: PdxBody; do_auto_disable: cint); cdecl; external {$IFDEF __GPC__}name 'dBodySetAutoDisableFlag'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dBodySetAutoDisableAverageSamplesCount(const Body: PdxBody; average_samples_count : cuint); cdecl; external {$IFDEF __GPC__}name 'dBodySetAutoDisableAverageSamplesCount'{$ELSE} ODEDLL{$ENDIF __GPC__};


  //----- dJoint -----
  {$IFDEF PARODE}
  // breakable joints
  procedure dJointSetBreakable (const dJointID : TdJointID; b: cint); cdecl; external {$IFDEF __GPC__}name 'dJointSetBreakable'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dJointSetBreakMode (const dJointID : TdJointID; mode: cint); cdecl; external {$IFDEF __GPC__}name 'dJointSetBreakMode'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dJointGetBreakMode (const dJointID : TdJointID): cint; cdecl; external {$IFDEF __GPC__}name 'dJointGetBreakMode'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dJointSetBreakForce(const dJointID : TdJointID; body : cint; x, y, z: TdReal); cdecl; external {$IFDEF __GPC__}name 'dJointSetBreakForce'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dJointSetBreakTorque(const dJointID : TdJointID; body : cint; x, y, z: TdReal); cdecl; external {$IFDEF __GPC__}name 'dJointSetBreakTorque'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dJointIsBreakable (const dJointID : TdJointID): cint; cdecl; external {$IFDEF __GPC__}name 'dJointIsBreakable'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dJointGetBreakForce(const dJointID : TdJointID; body : cint; var force: TdVector3); cdecl; external {$IFDEF __GPC__}name 'dJointGetBreakForce'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dJointGetBreakTorque(const dJointID : TdJointID; body : cint; var torque: TdVector3); cdecl; external {$IFDEF __GPC__}name 'dJointGetBreakTorque'{$ELSE} ODEDLL{$ENDIF __GPC__};
  {$ENDIF}
  ...
  function dJointGroupCreate(const max_size: cint): TdJointGroupID; cdecl; external {$IFDEF __GPC__}name 'dJointGroupCreate'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dJointGetType(const dJointID : TdJointID): cint; cdecl; external {$IFDEF __GPC__}name 'dJointGetType'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dJointGetBody(const dJointID : TdJointID; const index: cint): PdxBody; cdecl; external {$IFDEF __GPC__}name 'dJointGetBody'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dJointSetAMotorAngle(const dJointID : TdJointID; const anum: cint; const angle: TdReal); cdecl; external {$IFDEF __GPC__}name 'dJointSetAMotorAngle'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dJointGetAMotorAngle(const dJointID : TdJointID; const anum: cint): TdReal; cdecl; external {$IFDEF __GPC__}name 'dJointGetAMotorAngle'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dJointSetAMotorAxis(const dJointID : TdJointID; const anum, rel: cint; const x, y, z: TdReal); cdecl; external {$IFDEF __GPC__}name 'dJointSetAMotorAxis'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dJointGetAMotorAxis(const dJointID : TdJointID; const anum: cint; var result: TdVector3); cdecl; external {$IFDEF __GPC__}name 'dJointGetAMotorAxis'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dJointSetAMotorNumAxes(const dJointID : TdJointID; const num: cint); cdecl; external {$IFDEF __GPC__}name 'dJointSetAMotorNumAxes'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dJointGetAMotorNumAxes(const dJointID : TdJointID): cint; cdecl; external {$IFDEF __GPC__}name 'dJointGetAMotorNumAxes'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dJointGetAMotorMode(const dJointID : TdJointID): cint; cdecl; external {$IFDEF __GPC__}name 'dJointGetAMotorMode'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dJointGetAMotorAngleRate(const dJointID : TdJointID; const anum: cint): TdReal; cdecl; external {$IFDEF __GPC__}name 'dJointGetAMotorAngleRate'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dJointGetAMotorAxisRel(const dJointID : TdJointID; const anum: cint): cint; cdecl; external {$IFDEF __GPC__}name 'dJointGetAMotorAxisRel'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dJointSetLMotorAxis(const dJointID : TdJointID; const anum, rel: cint; const x, y, z: TdReal); cdecl; external {$IFDEF __GPC__}name 'dJointSetLMotorAxis'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dJointGetLMotorAxis(const dJointID : TdJointID; const anum: cint; var result: TdVector3); cdecl; external {$IFDEF __GPC__}name 'dJointGetLMotorAxis'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dJointSetLMotorNumAxes(const dJointID : TdJointID; const num: cint); cdecl; external {$IFDEF __GPC__}name 'dJointSetLMotorNumAxes'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dJointGetLMotorNumAxes(const dJointID : TdJointID): cint; cdecl; external {$IFDEF __GPC__}name 'dJointGetLMotorNumAxes'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dJointSetPlane2DXParam(const dJointID : TdJointID; const parameter: cint; const value: TdReal); cdecl; external {$IFDEF __GPC__}name 'dJointSetPlane2DXParam'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dJointSetPlane2DYParam(const dJointID : TdJointID; const parameter: cint; const value: TdReal); cdecl; external {$IFDEF __GPC__}name 'dJointSetPlane2DYParam'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dJointSetPlane2DAngleParam(const dJointID : TdJointID; const parameter: cint; const value: TdReal); cdecl; external {$IFDEF __GPC__}name 'dJointSetPlane2DAngleParam'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dJointGetPRParam(const dJointID : TdJointID; parameter: cint): TdReal; cdecl; external {$IFDEF __GPC__}name 'dJointGetPRParam'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dJointGetPistonParam(const dJointID : TdJointID; parameter : cint): TdReal; cdecl; external {$IFDEF __GPC__}name 'dJointGetPistonParam'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  //----- dGeom -----
  function dCreateGeom (classnum : cint) : PdxGeom; cdecl; external {$IFDEF __GPC__}name 'dCreateGeom'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dGeomDestroy(const Geom : PdxGeom); cdecl; external {$IFDEF __GPC__}name 'dGeomDestroy'{$ELSE} ODEDLL{$ENDIF __GPC__};

  function dCreateGeomClass(const classptr : TdGeomClass) : cint; cdecl; external {$IFDEF __GPC__}name 'dCreateGeomClass'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dGeomGetClass(const Geom : PdxGeom): cint; cdecl; external {$IFDEF __GPC__}name 'dGeomGetClass'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dGeomIsSpace (const Geom : PdxGeom) : cint; cdecl; external {$IFDEF __GPC__}name 'dGeomIsSpace'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  //JM THE FIRST ODE PROBLEM!!! dGeomGetPosition
  ...
  procedure dGeomSetRotation(const Geom : PdxGeom; var R: TdMatrix3); cdecl; external {$IFDEF __GPC__}name 'dGeomSetRotation'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dGeomCopyPosition(const Geom : PdxGeom; var pos: TdVector3); cdecl; external {$IFDEF __GPC__}name 'dGeomCopyPosition'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dGeomCopyRotation(const Geom : PdxGeom; var R: TdMatrix3); cdecl; external {$IFDEF __GPC__}name 'dGeomCopyRotation'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dGeomCopyQuaternion(const Geom : PdxGeom; var quat: TdQuaternion); cdecl; external {$IFDEF __GPC__}name 'dGeomCopyQuaternion'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dGeomIsEnabled (const Geom : PdxGeom) : cint; cdecl; external {$IFDEF __GPC__}name 'dGeomIsEnabled'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dGeomSetOffsetRotation (const Geom : PdxGeom; var R:TdMatrix3); cdecl; external {$IFDEF __GPC__}name 'dGeomSetOffsetRotation'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dGeomSetOffsetQuaternion (const Geom : PdxGeom; var Q:TdQuaternion); cdecl; external {$IFDEF __GPC__}name 'dGeomSetOffsetQuaternion'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dGeomSetOffsetWorldRotation (const Geom : PdxGeom; var R:TdMatrix3); cdecl; external {$IFDEF __GPC__}name 'dGeomSetOffsetWorldRotation'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dGeomSetOffsetWorldQuaternion (const Geom : PdxGeom; var Q:TdQuaternion); cdecl; external {$IFDEF __GPC__}name 'dGeomSetOffsetWorldQuaternion'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dGeomTransformSetInfo (const Geom : PdxGeom; mode : cint); cdecl; external {$IFDEF __GPC__}name 'dGeomTransformSetInfo'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dGeomTransformGetInfo (const Geom : PdxGeom) : cint; cdecl; external {$IFDEF __GPC__}name 'dGeomTransformGetInfo'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dGeomTransformSetCleanup(const Geom : PdxGeom; const mode: cint); cdecl; external {$IFDEF __GPC__}name 'dGeomTransformSetCleanup'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dGeomTransformGetCleanup(const Geom : PdxGeom): cint; cdecl; external {$IFDEF __GPC__}name 'dGeomTransformGetCleanup'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dCreateHeightfield(const Space : PdxSpace; Data: PdxHeightfieldData; bPlaceable:cint): PdxGeom; cdecl; external {$IFDEF __GPC__}name 'dCreateHeightfield'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dGeomRaySetParams(const Geom : PdxGeom; FirstContact, BackfacCull: cint); cdecl; external {$IFDEF __GPC__}name 'dGeomRaySetParams'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dGeomRayGetParams(const Geom : PdxGeom; var FirstContact, BackfacCull: cint); cdecl; external {$IFDEF __GPC__}name 'dGeomRayGetParams'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dGeomRaySetClosestHit(const Geom : PdxGeom; closestHit: cint); cdecl; external {$IFDEF __GPC__}name 'dGeomRaySetClosestHit'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dGeomRayGetClosestHit(const Geom : PdxGeom) : cint; cdecl; external {$IFDEF __GPC__}name 'dGeomRayGetClosestHit'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dGeomTriMeshIsTCEnabled(g: PdxGeom; geomClass: cint): cint; cdecl; external {$IFDEF __GPC__}name 'dGeomTriMeshIsTCEnabled'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dGeomTriMeshEnableTC(g: PdxGeom; geomClass, enable: cint); cdecl; external {$IFDEF __GPC__}name 'dGeomTriMeshEnableTC'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dGeomTriMeshGetTriangleCount(g: PdxGeom) : cint; cdecl; external {$IFDEF __GPC__}name 'dGeomTriMeshGetTriangleCount'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dGeomTriMeshGetTriangle(g: PdxGeom; Index: cint; v0, v1, v2: PdVector3); cdecl; external {$IFDEF __GPC__}name 'dGeomTriMeshGetTriangle'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dGeomTriMeshGetPoint(g: PdxGeom; Index: cint; u, v: TdReal; var result: TdVector3); cdecl; external {$IFDEF __GPC__}name 'dGeomTriMeshGetPoint'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dGeomTriMeshDataSet(g: PdxTriMeshData; data_id: cint; data: Pointer); cdecl; external {$IFDEF __GPC__}name 'dGeomTriMeshDataSet'{$ELSE} ODEDLL{$ENDIF __GPC__};

  procedure dGeomTriMeshDataBuildSimple(g: PdxTriMeshData; Vertices: PdVector3Array; VertexCount: cint; Indices: PdIntegerArray; IndexCount: cint); cdecl; external {$IFDEF __GPC__}name 'dGeomTriMeshDataBuildSimple'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dGeomTriMeshDataBuildSimple1(g: PdxTriMeshData; Vertices: PdVector3Array; VertexCount: cint; Indices: PdIntegerArray; IndexCount: cint; Normals: PdVector3Array); cdecl; external {$IFDEF __GPC__}name 'dGeomTriMeshDataBuildSimple1'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dGeomTriMeshDataBuildDouble(g: PdxTriMeshData; Vertices: PdVector3Array; VertexStride, VertexCount: cint; Indices: PdIntegerArray; IndexCount, TriStride: cint); cdecl; external {$IFDEF __GPC__}name 'dGeomTriMeshDataBuildDouble'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dGeomTriMeshDataBuildDouble1(g: PdxTriMeshData; Vertices: PdVector3Array; VertexStride, VertexCount: cint; Indices: PdIntegerArray; IndexCount, TriStride: cint; Normals: PdVector3Array); cdecl; external {$IFDEF __GPC__}name 'dGeomTriMeshDataBuildDouble1'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dGeomTriMeshDataBuildSingle(g: PdxTriMeshData; Vertices: PdVector3Array; VertexStride, VertexCount: cint; Indices: PdIntegerArray; IndexCount, TriStride: cint); cdecl; external {$IFDEF __GPC__}name 'dGeomTriMeshDataBuildSingle'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dGeomTriMeshDataBuildSingle1(g: PdxTriMeshData; Vertices: PdVector3Array; VertexStride, VertexCount: cint; Indices: PdIntegerArray; IndexCount, TriStride: cint; Normals: PdVector3Array); cdecl; external {$IFDEF __GPC__}name 'dGeomTriMeshDataBuildSingle1'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dQuadTreeSpaceCreate(const Space : PdxSpace; var Center : TdVector3; var Extents : TdVector3; const Depth : cint): PdxSpace; cdecl; external {$IFDEF __GPC__}name 'dQuadTreeSpaceCreate'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dSpaceQuery (const Space : PdxSpace; const Geom : PdxGeom): cint; cdecl; external {$IFDEF __GPC__}name 'dSpaceQuery'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dSpaceGetNumGeoms (const Space: PdxSpace) : cint; cdecl; external {$IFDEF __GPC__}name 'dSpaceGetNumGeoms'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dSpaceGetGeom (const Space: PdxSpace; const i: cint) : PdxGeom; cdecl; external {$IFDEF __GPC__}name 'dSpaceGetGeom'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dHashSpaceSetLevels(const Space: PdxSpace; const minlevel, maxlevel: cint); cdecl; external {$IFDEF __GPC__}name 'dHashSpaceSetLevels'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dHashSpaceGetLevels(const Space: PdxSpace; var minlevel, maxlevel: cint); cdecl; external {$IFDEF __GPC__}name 'dHashSpaceGetLevels'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dSpaceSetCleanup (space : PdxSpace; const mode : cint); cdecl; external {$IFDEF __GPC__}name 'dSpaceSetCleanup'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dSpaceGetCleanup(Space : PdxSpace): cint; cdecl; external {$IFDEF __GPC__}name 'dSpaceGetCleanup'{$ELSE} ODEDLL{$ENDIF __GPC__};

  function dCollide (o1, o2 : PdxGeom; flags : cint; var Contact : TdContactGeom; Skip : cint) : cint; cdecl; external {$IFDEF __GPC__}name 'dCollide'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dMassSetCylinder(var m: TdMass; density: TdReal; direction: cint; radius, length: TdReal); cdecl; external {$IFDEF __GPC__}name 'dMassSetCylinder'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dMassSetCylinderTotal(var m: TdMass; total_mass: TdReal; direction: cint; radius, length: TdReal); cdecl; external {$IFDEF __GPC__}name 'dMassSetCylinderTotal'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dMassSetCapsule(var m: TdMass; density: TdReal; direction: cint; radius, length: TdReal); cdecl; external {$IFDEF __GPC__}name 'dMassSetCapsule'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dMassSetCapsuleTotal(var m: TdMass; total_mass: TdReal; direction: cint; radius, length: TdReal); cdecl; external {$IFDEF __GPC__}name 'dMassSetCapsuleTotal'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  procedure dMultiply0 (const A : PdReal; const B, C : PdReal; p, q, r : cint); cdecl; external {$IFDEF __GPC__}name 'dMultiply0'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dMultiply1 (const A : PdReal; const B, C : PdReal; p, q, r : cint); cdecl; external {$IFDEF __GPC__}name 'dMultiply1'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dMultiply2 (const A : PdReal; const B, C : PdReal; p, q, r : cint); cdecl; external {$IFDEF __GPC__}name 'dMultiply2'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dQMultiply0 (var qa: TdQuaternion; var qb: TdQuaternion; var qc: TdQuaternion); cdecl; external {$IFDEF __GPC__}name 'dQMultiply0'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dQMultiply1 (var qa: TdQuaternion; var qb: TdQuaternion; var qc: TdQuaternion); cdecl; external {$IFDEF __GPC__}name 'dQMultiply1'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dQMultiply2 (var qa: TdQuaternion; var qb: TdQuaternion; var qc: TdQuaternion); cdecl; external {$IFDEF __GPC__}name 'dQMultiply2'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dQMultiply3 (var qa: TdQuaternion; var qb: TdQuaternion; var qc: TdQuaternion); cdecl; external {$IFDEF __GPC__}name 'dQMultiply3'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dRfromQ (var R : TdMatrix3; var q : TdQuaternion); cdecl; external {$IFDEF __GPC__}name 'dRfromQ'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dQfromR (var q : TdQuaternion; var R : TdMatrix3); cdecl; external {$IFDEF __GPC__}name 'dQfromR'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dDQfromW (var dq : TdVector4; var w : TdVector3; var q: TdQuaternion); cdecl; external {$IFDEF __GPC__}name 'dDQfromW'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  //----- Misc -----
  procedure dClosestLineSegmentPoints (var a1 : TdVector3; var a2 : TdVector3; var b1 : TdVector3; var b2 : TdVector3; var cp1 : TdVector3; var cp2 : TdVector3); cdecl; external {$IFDEF __GPC__}name 'dClosestLineSegmentPoints'{$ELSE} ODEDLL{$ENDIF __GPC__};

  function dBoxTouchesBox (var _p1 : TdVector3; var R1 : TdMatrix3; var side1 : TdVector3; var _p2 : TdVector3; var R2 : TdMatrix3; var side2 : TdVector3) : cint; cdecl; external {$IFDEF __GPC__}name 'dBoxTouchesBox'{$ELSE} ODEDLL{$ENDIF __GPC__};

  function dMaxDifference (A, B : PdReal; n, m : cint) : TdReal; cdecl; external {$IFDEF __GPC__}name 'dMaxDifference'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dMakeRandomVector(var n1 : TdVector3; a : cint; f : TdReal); cdecl; external {$IFDEF __GPC__}name 'dMakeRandomVector'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dAreConnected (a, b : PdxBody) : cint; cdecl; external {$IFDEF __GPC__}name 'dAreConnected'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dAreConnectedExcluding (a, b : PdxBody; joint_type : TdJointTypeNumbers) : cint; cdecl; external {$IFDEF __GPC__}name 'dAreConnectedExcluding'{$ELSE} ODEDLL{$ENDIF __GPC__};

  procedure dMakeRandomMatrix (A : PdRealArray; n, m : cint; range :  TdReal); cdecl; external {$IFDEF __GPC__}name 'dMakeRandomMatrix'{$ELSE} ODEDLL{$ENDIF __GPC__};
  procedure dClearUpperTriangle (A : PdRealArray; n : cint); cdecl; external {$IFDEF __GPC__}name 'dClearUpperTriangle'{$ELSE} ODEDLL{$ENDIF __GPC__};
  ...
  function dRandInt (const n: cint): cint; cdecl; external {$IFDEF __GPC__}name 'dRandInt'{$ELSE} ODEDLL{$ENDIF __GPC__};
  function dRandReal: TdReal; cdecl; external {$IFDEF __GPC__}name 'dRandReal'{$ELSE} ODEDLL{$ENDIF __GPC__};

  // return 1 if the random number generator is working.
  function dTestRand: cint; cdecl; external {$IFDEF __GPC__}name 'dTestRand'{$ELSE} ODEDLL{$ENDIF __GPC__};
...
var
  ...
  dSphereClass : cint=0;
  dBoxClass : cint=1;
  dCapsuleClass : cint=2;
  dCylinderClass : cint=3;
  dPlaneClass : cint=4;
  dRayClass : cint=5;
  dConvexClass : cint=6;
  dGeomTransformClass : cint=7;
  dTriMeshClass : cint=8;
  dHeightFieldClass : cint=9;
  dFirstSpaceClass : cint = 10;
  dSimpleSpaceClass : cint = 10;
  dHashSpaceClass : cint = 11;
  dSweepAndPruneSpaceClass : cint = 12;
  dQuadTreeSpaceClass : cint = 13;
  dLastSpaceClass : cint = 13;
  dFirstUserClass : cint = 14;
  dLastUserClass : cint = 17;
  dGeomNumClasses : cint = 18;
...
function TBodyList.GetItems(i: cint): PdxBody;
begin
  result := Get(i);
end;

procedure TBodyList.SetItems(i: cint; const Value: PdxBody);
begin
  Put(i, Value);
end;
...
function TGeomList.GetItems(i: cint): PdxGeom;
begin
   result := Get(i);
end;

procedure TGeomList.SetItems(i: cint; const Value: PdxGeom);
begin
   Put(i, Value);
end;
