...
begin
  ...
  CL.AddTypeS('THistogram', 'record binUpperLimit : array of double; binHeight '
   +': array of integer; end');
 ...
 CL.AddDelphiFunction('Function GetPaintGunMinDist( i : integer) : double');
 ...
 CL.AddDelphiFunction('Function CalculateSprayThicknessHistogram( i : integer; numberOfBins : integer) : THistogram');
 ...
 CL.AddDelphiFunction('Procedure SetThingLinearVel( T : integer; x, y, z : double)');
 CL.AddDelphiFunction('Procedure SetThingAngularVel( T : integer; x, y, z : double)');
...
begin
 ...
 S.RegisterDelphiFunction(@GetPaintGunMinDist, 'GetPaintGunMinDist', cdRegister);
 ...
 S.RegisterDelphiFunction(@CalculateSprayThicknessHistogram, 'CalculateSprayThicknessHistogram', cdRegister);
 ...
 S.RegisterDelphiFunction(@SetThingLinearVel, 'SetThingLinearVel', cdRegister);
 S.RegisterDelphiFunction(@SetThingAngularVel, 'SetThingAngularVel', cdRegister);
