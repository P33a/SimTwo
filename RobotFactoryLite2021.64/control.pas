...
begin
  ...
  //end else if channel = 'r' then begin
    ...
    SetRCValue(18, 2, chr(value shr 24) + chr($FF and (value shr 16)) + chr($FF and (value shr 8)) + chr($FF and (value shr 0)));
...
begin
  ...
  Canvas.textout(50, 50, GetRCText(18, 2));
end;
